...
def main():
    ...
    if platform.system() == 'Linux':
        home = '/private/home/broz/'
    else:
        home = "/Users/broz/"
    folder_GT = os.path.join(home, 'workspaces/tests_malagan/malagan/flickr/HR')
    folder_Gen = os.path.join(home,'workspaces/tests_malagan/malagan/results/ESRGANplus_x4/set5/set5_log_koncept_OnePlusOne_CMA_pessimistic_scores_grid_search')
