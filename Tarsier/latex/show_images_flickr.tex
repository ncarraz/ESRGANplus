...
%\def\method{_koncept_512_DiagonalCMA_bud1000_penal0.002}
%\def\method{_koncept_512_DiagonalCMA_penal2.0_27600_disc0.01_clamping2.5_bud10000}
\def\method{_koncept_512_DiagonalCMA_penal1.0_27600_disc0.01_clamping2.5_bud10000}
%\def\secondmethod{_koncept_512_DiagonalCMA_bud5000_penal0.0025_6900}
\def\imageDir{/Users/broz/workspaces/tests_malagan/malagan/results/ESRGANplus_x4/}
\def\baseline{_koncept_512_Baseline}
\def\setdir{flickr/flickr_log_koncept_OnePlusOne_CMA_pessimistic_scores_grid_search}
...
\foreach \picname in {000001, 000002, 000007, 000012, 000071, 000079, 000201, 000214, 000216, 000220, 000379, 000399, 000405, 000407, 000496, 000512, 000516, 000517}
  {
\begin{figure}
  ...
  \begin{subfigure}{0.5\textwidth}
    ...
    \zoombox[color code=red]{0.2,0.7}
...
%  \includegraphics[width=0.9\linewidth]{{\imageDir \setdir/\picname\secondmethod}.png}
%%  \caption{\picname method 2}
%\end{subfigure}
\caption{\picname}
\label{fig:\picname}
\end{figure}
